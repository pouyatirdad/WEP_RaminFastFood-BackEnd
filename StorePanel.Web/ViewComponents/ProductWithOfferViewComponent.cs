...
{
    public class ProductWithOfferViewComponent : ViewComponent
    {
        private readonly IProductsRepository _productsRepository;
        private readonly IProductService _productService;

        public ProductWithOfferViewComponent(IProductsRepository productsRepository, IProductService productService)
        {
